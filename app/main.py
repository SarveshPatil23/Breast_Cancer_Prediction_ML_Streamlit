...
def add_sidebar():
    st.sidebar.header("Cell Nuclei Meeasurements")
    data=get_clean_data()
...
def main():
    ...
    with st.container():
        ...
        st.write("Please connect this app to your cytology lab to help diagnose breast cancer form your tissue sample. This app predicts using a machine learning model whether a breast mass is benign or malignant based on the measurements it receives from your cytosis lab. You can also update the measurements by hand using the sliders in the sidebar. Benign: These tumors are not cancerous. Malignant: These tumors are cancerous.")
